...
/**
 * This mapper writes each line of data to a row in HBase using the md5 hash of the data
 * as the rowkey.
 */
public class MD5RowMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, Mutation> {
